...
#ruta donde se guarda el recibo generado
    ruta_recibos = '..\MK-2.0\System\Data\Recibos'#Cambia dependiendo de donde este trabajando el proyecto (SI se deja en blanco el STR, SE GUARDA EN LA CARPETA RAIZ (Sistem))
