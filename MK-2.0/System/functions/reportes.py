...
# Total de compras
    ...
    ruta_reportes = '..\MK-2.0\System\Data\Reportes' # Cambia dependiendo de donde este trabajando el proyecto (SI se deja en blanco el STR, SE GUARDA EN LA CARPETA RAIZ (Sistem))
