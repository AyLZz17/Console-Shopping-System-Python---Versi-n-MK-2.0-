...
# Total de compras
    ...
    ruta_reportes = r"..\MK-2.01\System\Data\Reportes" # Cambia dependiendo de donde este trabajando el proyecto (SI se deja en blanco el STR, SE GUARDA EN LA CARPETA RAIZ (Sistem))
